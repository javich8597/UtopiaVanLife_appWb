            ...
            <div className="auth-page__card">
                ...
                <form onSubmit={handleRegister} className="auth-page__form">
                    ...
                    <p className="text-xs" style={{ color: 'var(--gray-400)', textAlign: 'center', lineHeight: 1.5 }}>
                        ...
                        <Link href="/legal/privacidad" style={{ color: 'var(--forest-green)' }}>política de privacidad</Link>
                        {' '}y los{' '}
                        <Link href="/legal/terminos" style={{ color: 'var(--forest-green)' }}>términos de uso</Link>.
                    </p>
                </form>
